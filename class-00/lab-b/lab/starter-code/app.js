...
// Arrow function doesn't bind to the object when used for construction function. Using this keyword doesn't refer to the object where the function was created. 
...
// this keyword refered to the instance of an object when regular function is used

// 2. What is "this" when joe.scopeArrow() is invoked?
// arrow function doesn't bind the function to the object and it doesn't have it own this. Console logging this refers to the window. 

// 3. Explain why "this" is different when an arrow function is used.
// When arrow function is used it doesn't have its own this unlike regular function. It follows the normal variable look up rules and end up finding the this from its enclosing scope.
