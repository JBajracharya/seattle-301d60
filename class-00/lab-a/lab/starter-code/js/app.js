...
function displayPics(){
  ...
  //rando is a const variable and defined inside the function and it is only available inside the function. When console log is called, it is not recognized outside the function. 
